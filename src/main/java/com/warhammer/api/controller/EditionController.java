...
public class EditionController {
	...
	public Edition getEdition(@PathVariable("id") final Long id){
	...
	public Edition updateEdition(@PathVariable("id") final Long id, @RequestBody Edition edition) {
	...
	public Edition patchEdition(@PathVariable("id") final Long id, @RequestBody Edition edition){
		Optional<Edition> e = editionService.getEdition(id);
		if(e.isPresent()) {
			Edition currentEdition = e.get();
